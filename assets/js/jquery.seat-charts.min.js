...
!(function (t) {
  t.fn.seatCharts = function (s) {
        ...
        return function (n) {
          ...
          (i.settings = t.extend(
            ...
            i.settings.$node
              ...
              .text(i.settings.label)
              .addClass(
                ["seatCharts-seat", "seatCharts-cell", "available"]
                  .concat(
                    i.settings.classes,
                    "undefined" == typeof e.seats[i.settings.character]
                      ? []
                      : e.seats[i.settings.character].classes
                  )
                  .join(" ")
              ),
            (i.data = function () {
              ...
              return 1 == arguments.length
                ? (function (t) {
                    ...
                    return t == s
                      ? s
                      : ((i.settings.status =
                          "focused" != t ? t : i.settings.status),
                        i.settings.$node.attr("aria-checked", "selected" == t),
                        e.animate
                          ? i.settings.$node.switchClass(s, t, 200)
                          : i.settings.$node.removeClass(s).addClass(t),
                        (i.settings.style = t));
                  })(arguments[0])
                : i.settings.style;
            }),
            (i.status = function () {
              return (i.settings.status =
                1 == arguments.length
                  ? i.style(arguments[0])
                  : i.settings.status);
            }),
            (function (n, r, c) {
              t.each(["click", "focus", "blur"], function (t, u) {
                i[u] = function () {
                  return (
                    "focus" == u &&
                      (void 0 !== s.attr("aria-activedescendant") &&
                        a[s.attr("aria-activedescendant")].blur(),
                      s.attr("aria-activedescendant", c.settings.id),
                      c.node().focus()),
                    i.style(
                      "function" == typeof n[r][u]
                        ? n[r][u].apply(c)
                        : e[u].apply(c)
                    )
                  );
            ...
            i
              .node()
              .on("click", i.click)
              .on("mouseenter", i.focus)
              .on("mouseleave", i.blur)
              .on(
                "keydown",
                (function (t, e) {
                  return function (n) {
                    ...
                    switch (n.which) {
                      ...
                      case 38:
                        if (
                          ...
                          (i = (function r(t, s, a) {
                            ...
                            return (
                              (c =
                                t.index(a) || 38 != n.which
                                  ? t.index(a) == t.length - 1 && 40 == n.which
                                    ? t.first()
                                    : t.eq(
                                        t.index(a) + (38 == n.which ? -1 : 1)
                                      )
                                  : t.last()),
                              (i = c
                            ...
                            e
                              ...
                              .find(".seatCharts-seat,.seatCharts-space"),
                            e.parents(".seatCharts-row:not(.seatCharts-header)")
                          )),
                          !i.length)
                        )
                          return;
                      ...
                      case 39:
                        if (
                          (n.preventDefault(),
                          (i = (function (t) {
                            return t.index(e) || 37 != n.which
                              ? t.index(e) == t.length - 1 && 39 == n.which
                                ? t.first()
                                : t.eq(t.index(e) + (37 == n.which ? -1 : 1))
                              : t.last();
                          })(
                            e
    ...
    if (
      (e.addClass("seatCharts-container"),
      t.extend(!0, i, s),
      (i.naming.rows =
        i.naming.rows ||
        (function (t) {
    ...
    return (
        ...
        i.naming.left &&
          u.append(
            t("<div></div>")
              ...
              .text(i.naming.rows[s])
          ),
          t.each(
            c.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi),
            function (e, c) {
      ...
      i.legend.items.length
        ? (function (s) {
            var a = (s.node || t("<div></div>").insertAfter(e)).addClass(
                "seatCharts-legend"
              ),
              n = t("<ul></ul>").addClass("seatCharts-legendList").appendTo(a);
            return (
              t.each(s.items, function (s, e) {
                n.append(
                  t("<li></li>")
                    .addClass("seatCharts-legendItem")
                    .append(
                      t("<div></div>").addClass(
                        ["seatCharts-seat", "seatCharts-cell", e[1]]
                          .concat(
                            i.classes,
                            "undefined" == typeof i.seats[e[0]]
                              ? []
                              : i.seats[e[0]].classes
                          )
                          .join(" ")
      ...
      e.attr({ tabIndex: 0 }),
      e.focus(function () {
        e.attr("aria-activedescendant") &&
          a[e.attr("aria-activedescendant")].blur(),
        ...
        set: function u() {
          ...
          return {
            ...
            status: function () {
              var s = arguments,
                e = this;
              return 1 == this.length && 0 == s.length
                ? this.seats[0].status()
                : (function () {
